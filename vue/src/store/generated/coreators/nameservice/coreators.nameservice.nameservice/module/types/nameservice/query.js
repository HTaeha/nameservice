...
export class QueryClientImpl {
    ...
    Whois(request) {
        ...
        const promise = this.rpc.request('coreators.nameservice.nameservice.Query', 'Whois', data);
    ...
    WhoisAll(request) {
        ...
        const promise = this.rpc.request('coreators.nameservice.nameservice.Query', 'WhoisAll', data);
